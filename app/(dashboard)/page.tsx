  ...
  const stats = [
    {
      ...
      value: grantsCount || 0,
      description: 'Active grants to explore',
      icon: (
  ...
  return (
    <div className="space-y-8">
      ...
      <div className="grid gap-4 md:grid-cols-2 lg:grid-cols-4">
        {stats.map((stat) => (
          <Card key={stat.name} className="relative overflow-hidden group hover:shadow-md transition-all duration-200">
            {/* Accent top border */}
          ...
          <CardContent>
            {upcomingDeadlines && upcomingDeadlines.length > 0 ? (
                ...
                {upcomingDeadlines.map((item) => {
                  ...
                  return (
                    <Link
                      ...
                      className="block p-3 rounded-lg border border-border hover:bg-accent/50 hover:border-primary/20 transition-all duration-150"
                    >
              ...
              <div className="text-center py-6">
                <svg xmlns="http://www.w3.org/2000/svg" className="mx-auto h-10 w-10 text-muted-foreground/30" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="1">
      ...
      <div className="grid gap-4 md:grid-cols-2">
        ...
        <Card className="hover:shadow-md transition-all duration-200">
          ...
          <CardContent className="grid gap-2">
            <Button asChild variant="outline" className="justify-start hover:border-primary/20 hover:bg-accent/50 transition-all duration-150">
              <Link href="/grants">
